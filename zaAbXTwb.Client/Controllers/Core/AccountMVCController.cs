  ...
  public class AccountMvcController : Controller
  {
    ...
    public async Task<IActionResult> Login(LoginViewModel viewModel, string returnUrl = null)
    {
      ...
      if (ModelState.IsValid)
      {
        ...
        {
          return RedirectToAction(nameof(LoginWith2fa), new { returnUrl, viewModel.RememberMe });
        }
    ...
    public IActionResult ExternalLogin(string provider, string returnUrl = null)
    {
      ...
      var redirectUrl = Url.Action(nameof(ExternalLoginCallback), "AccountMvc", new { returnUrl });
